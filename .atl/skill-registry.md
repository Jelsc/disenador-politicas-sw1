# Skill Registry — Disenador-Politicas-sw1
...
| `interface-design` | This skill is for interface design — dashboards, admin panels, apps, tools, and interactive products. NOT for marketing design (landing pages, marketing sites, campaigns). | project | `C:\Users\nelso\Documents\Docker Proyectos\Disenador-Politicas-sw1\.agents\skills\interface-design\SKILL.md` |
